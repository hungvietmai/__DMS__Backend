    ...
    '@nestjs/swagger': {
      ...
      controllers: [
        [
          ...
          {
            UsersController: {
              create: { type: t['./shared/user/schemas/user.schema.js'].User },
              findAll: { type: [t['./shared/user/schemas/user.schema.js'].User] },
              findOne: { type: Object },
            },
          },
        ],
        [import('./auth/auth.controller.js'), { AuthController: { login: {}, check: { type: Object } } }],
